...
export const BASE_ADOS = MASTER_BASEADO.filter(ado => MASTER_ADOENABLE[ado.$id]);
export const MODIFIERS = MASTER_MODIFIER;
export const MODULES = MASTER_MODULE.filter(ado => MASTER_ADOENABLE[ado.$id]);
export const PRIMITIVES = MASTER_PRIMITIVE.filter(ado => MASTER_ADOENABLE[ado.$id]);
