...
const Introduction: FC<IntroductionProps> = (props) => {
    ...
    return (
        <Box>
            ...
            <Text mt='3'>
                To solve this problem, we have built the Andromeda CLI. The CLI is an all encompassing tool to allow users quick and easy interaction with any of the chains that Andromeda is deployed on. You can check the homepage of our website to see what chains Andromeda is deployed on or looking to deploy on.
            </Text>
        </Box>
    )
}
