...
import { Box, BoxProps, Flex, CloseButton, Image, Divider, Text } from "@chakra-ui/react";
...
const Sidebar = ({ onClose, activeLink, ...props }: SidebarProps) => {
  return (
    ...
    >
      ...
      <Text pl='4' my='2' fontSize='xs' fontWeight='light' fontStyle='light'>Andromeda App 1.5.0</Text>
    </Box>
  );
};
